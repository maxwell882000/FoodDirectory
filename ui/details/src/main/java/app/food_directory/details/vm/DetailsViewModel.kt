...
import app.food_directory.details.vm.ViewEvent.GetRecipe
import app.food_directory.details.vm.ViewEvent.ToggleBookMark
import app.food_directory.details.vm.ViewResult.ErrorResult
import app.food_directory.details.vm.ViewResult.NoOpResult
import app.food_directory.details.vm.ViewResult.RecipeItem
import app.food_directory.domain.usecases.ToggleSavedRecipeUseCase
import app.food_directory.domain.usecases.recipes.information.GetRecipeInformationUseCase
