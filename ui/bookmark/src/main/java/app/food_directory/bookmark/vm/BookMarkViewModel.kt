...
import app.food_directory.bookmark.vm.ViewEvent.GetSavedRecipes
import app.food_directory.bookmark.vm.ViewEvent.ToggleBookMark
import app.food_directory.bookmark.vm.ViewResult.ErrorResult
import app.food_directory.bookmark.vm.ViewResult.NoOpResult
import app.food_directory.bookmark.vm.ViewResult.SavedRecipes
import app.food_directory.data.db.recipes.mapper.toRecipesItem
import app.food_directory.domain.usecases.ToggleSavedRecipeUseCase
import app.food_directory.domain.usecases.recipes.bookmark.GetSavedRecipesUseCase
